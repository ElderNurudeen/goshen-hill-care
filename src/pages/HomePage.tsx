        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-12 sm:py-16">
          ...
          >
            <span className="inline-block px-3 py-1 rounded-full bg-lilac-100 text-lilac-700 font-medium text-xs sm:text-sm mb-4 sm:mb-5">
              Goshen-hill Care Limited
            </span>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-charcoal mb-4 sm:mb-5 leading-tight">
              Compassionate Care in the{" "}
              <span className="text-lilac-600">Heart of Kent</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-charcoal-light mb-4 leading-relaxed">
                At Goshen-hill Care, we understand that the roots of health lie
                not in hospitals, but in our people and communities. We are
                passionate about ensuring that the aging population is well
                taken care of with uncompromising service.
              </p>
